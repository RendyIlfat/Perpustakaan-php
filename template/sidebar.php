        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="index.php" class="nav-link">
              <i class='fas fa-chart-bar fa-lg' style="padding-left: 2px;"></i>
              <p>
                Dashboard
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class='fas fa-shopping-cart fa-lg' style="padding-left: 2px;"></i>
              <p>
                Peminjaman
                <i class="right fas fa-angle-left"></i>
              </p>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class='fas fa-user-tie fa-lg'  style="padding-left: 2px;"></i>
              <p>
                Admin
                <i class="right fas fa-angle-left"></i>
              </p>
